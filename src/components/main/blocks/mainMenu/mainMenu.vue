<script setup>
    ...
    const menu = reactive(Object.entries(manifestData.menu.items).map(([key, value]) => ({...value, id: key})))
    ...
    <div class="flex flex-col items-center justify-center">
        <div v-for="item in menu" :key="item.id">
            <Popover v-if="item.dropdown" class="relative">
                ...
                <PopoverPanel class="absolute z-10 w-48 p-4 bg-white rounded-lg shadow-lg">
