...
const X = {},
  ...
  Ro = /-(\w)/g,
  Me = ln((e) => e.replace(Ro, (t, n) => (n ? n.toUpperCase() : ""))),
  Po = /\B([A-Z])/g,
  vt = ln((e) => e.replace(Po, "-$1").toLowerCase()),
  ...
  get dirty() {
    if (this._dirtyLevel === 1) {
      ...
      for (let t = 0; t < this._depsLength; t++) {
        const n = this.deps[t]
        if (n.computed && ($o(n.computed), this._dirtyLevel >= 2)) break
      }
...
const jo = Wn("__proto__,__v_isRef,__isVue"),
  yr = new Set(
...
class vr {
  ...
  get(t, n, s) {
    ...
    if (n === "__v_raw")
      return s === (r ? (o ? Xo : wr) : o ? xr : Er).get(t) ||
    ...
    return (rn(n) ? yr.has(n) : jo(n)) || (r || de(t, "get", n), o)
      ? u
      : he(u)
        ? i && Gn(n)
          ? u
...
const [Wo, qo, zo, Go] = ko()
function ts(e, t) {
  const n = t ? (e ? Go : zo) : e ? qo : Wo
  return (s, r, o) =>
    r === "__v_isReactive"
      ? !e
      : r === "__v_isReadonly"
...
function fn(e) {
  return gt(e) ? e : ns(e, !1, Ko, Qo, Er)
}
function Rr(e) {
  return ns(e, !1, Do, Yo, xr)
}
function Pr(e) {
  return ns(e, !0, Vo, Jo, wr)
}
...
function os(e) {
  ;(!ie.length || !ie.includes(e, It && e.allowRecurse ? Ie + 1 : Ie)) &&
    (e.id == null ? ie.push(e) : ie.splice(li(e.id), 0, e), Lr())
}
function Lr() {
...
function ai(e, t, ...n) {
  ...
  if (i && i in s) {
    ...
    g && (r = n.map((v) => (re(v) ? v.trim() : v))), h && (r = n.map(Co))
  }
  let u,
...
function bn(e) {
  ...
  if (T && N !== !1) {
    const k = Object.keys(T),
      { shapeFlag: ee } = j
    k.length && ee & 7 && (i && k.some(qn) && (T = pi(T, i)), (j = mt(j, T)))
  }
  return (
...
function ft(e, t, n = 0, s) {
  ...
  else if (wo(e)) for (const r in e) ft(e[r], t, n, s)
  return e
}
function Je(e, t, n, s) {
  const r = e.dirs,
...
function kr(e, t, n = le) {
  ...
  if ((hn(t, s, n), n)) {
    let r = n.parent
    for (; r && r.parent; ) Dr(r.parent.vnode) && Si(s, t, n, r), (r = r.parent)
  }
}
function Si(e, t, n, s) {
  const r = hn(t, e, s, !0)
...
function Ji(e, t) {
  ...
  const {
    ...
    bt = (l, f, p, y, m, x, P) => {
      const E = (l.component = dl(l, y, m))
      if ((Dr(l) && (E.ctx.renderer = O), hl(E), E.asyncDep)) {
  ...
  let q, Y
  return t && ([q, Y] = t(O)), { render: R, hydrate: q, createApp: ki(R, q) }
}
...
function il(e, t = null, n = null, s = 0, r = null, o = !1) {
  ...
  const i = re(e) ? 1 : bi(e) ? 128 : el(e) ? 64 : Z(e) ? 4 : U(e) ? 2 : 0
  return ol(e, t, n, s, r, i, o, !0)
}
function ll(e) {
...
function pl(e, t) {
  const n = e.type
  ;(e.accessCache = Object.create(null)), (e.proxy = Sr(new Proxy(e.ctx, ji)))
  const { setup: s } = n
  if (s) {
...
const ql = (e, t) => {
  ...
  zl = {}
function Gl(e, t) {
  const n = _i("router-view")
  return tl(), rl(n)
}
const Ql = ql(zl, [["render", Gl]]),
  Yl = {
    __name: "Main",
...
function yt(e, t) {
  return z(new Error(), { type: e, [co]: !0 }, t)
}
function Le(e, t) {
  return e instanceof Error && co in e && (t == null || !!(e.type & t))
}
const Xs = "[^/]+?",
...
function Pc(e, t) {
  ...
  function c(a) {
    ...
    for (
      ...
      h < n.length &&
      bc(a, n[h]) >= 0 &&
      (a.record.path !== n[h].record.path || !uo(a, n[h]));
  ...
  function d(a, h) {
    ...
    return { name: N, path: A, params: v, matched: L, meta: Oc(L) }
  }
  return (
    e.forEach((a) => o(a)),
    {
...
function Hc(e) {
  return fs(e).replace(po, "{").replace(go, "}").replace(ho, "^")
}
function Dn(e) {
  return fs(e)
    .replace(ao, "%2B")
...
function Uc(e) {
  return fs(e).replace(fo, "%23").replace(Mc, "%3F")
}
function Kc(e) {
...
function or(e) {
  const t = je(as),
    ...
    o = be(() => r.value > -1 && Qc(n.params, s.value.params)),
    i = be(
      () =>
        r.value > -1 &&
...
function Xc(e) {
  ...
  function v(_, C) {
    let R, O
    return (
      lo(_) ? ((R = t.getRecordMatcher(_)), (O = C)) : (O = _), t.addRoute(O, R)
    )
  }
  function A(_) {
  ...
  function T(_, C) {
    ...
    const Y = ec(s, z({}, _, { hash: Hc(q), path: O.path })),
      l = r.createHref(Y)
    return z(
      { fullPath: Y, hash: q, query: s === sr ? Dc(_.query) : _.query || {} },
      O,
  ...
  function ce(_, C) {
    ...
    let y
    return (
      !Y && tc(s, O, R) && ((y = yt(16, { to: p, from: O })), Se(O, O, !0, !1)),
  ...
  function bt() {
    Ce ||
      (Ce = r.listen((_, C, R) => {
        ...
        d = O
        const Y = c.value
        ut && uc(Qs(Y.fullPath, R.delta), _n()),
          Pe(O, Y)
            .catch((l) =>
              Le(l, 12)
                ? l
  ...
  const lt = new Set(),
    jt = {
      ...
      install(_) {
        ...
        const R = {}
        for (const q in Ve)
          Object.defineProperty(R, q, { get: () => c.value[q], enumerable: !0 })
        _.provide(as, C), _.provide(mo, Rr(R)), _.provide(kn, c)
        const O = _.unmount
        lt.add(_),
          (_.unmount = function () {
            lt.delete(_),
